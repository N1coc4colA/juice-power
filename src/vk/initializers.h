...
VkRenderingAttachmentInfo attachment_info(VkImageView view, VkClearValue *clear, const VkImageLayout layout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
...
VkRenderingInfo rendering_info(const VkExtent2D &renderExtent, VkRenderingAttachmentInfo *colorAttachment, VkRenderingAttachmentInfo *depthAttachment);
...
VkDescriptorSetLayoutCreateInfo descriptorset_layout_create_info(VkDescriptorSetLayoutBinding *bindings, const uint32_t bindingCount);
VkWriteDescriptorSet write_descriptor_image(const VkDescriptorType type, VkDescriptorSet dstSet, VkDescriptorImageInfo *imageInfo, const uint32_t binding);
VkWriteDescriptorSet write_descriptor_buffer(const VkDescriptorType type, VkDescriptorSet dstSet, VkDescriptorBufferInfo *bufferInfo, const uint32_t binding);
