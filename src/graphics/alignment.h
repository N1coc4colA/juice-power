...
private:
    ...
    std::array<std::byte, S> m_reserved{};
...
template<typename S>
    requires details::isOneOfV<S, int8_t, uint8_t>
constexpr auto std430Compliant() -> size_t
{
    return 1;
}
...
template<typename S>
    requires details::isOneOfV<S, int16_t, uint16_t>
constexpr auto std430Compliant() -> size_t
{
    return 2;
}
...
template<typename S>
    requires details::isOneOfV<S, int, float, uint, bool>
constexpr auto std430Compliant() -> size_t
{
    return 4;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::vec2, glm::ivec2, glm::uvec2, glm::bvec2, VkDeviceAddress>
constexpr auto std430Compliant() -> size_t
{
    return 8;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::vec3, glm::ivec3, glm::uvec3, glm::bvec3>
constexpr auto std430Compliant() -> size_t
{
    return 16;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::vec4, glm::ivec4, glm::uvec4, glm::bvec4>
constexpr auto std430Compliant() -> size_t
{
    return 16;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::mat2>
constexpr auto std430Compliant() -> size_t
{
    return 8;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::mat3>
constexpr auto std430Compliant() -> size_t
{
    return 16;
}
...
template<typename S>
    requires details::isOneOfV<S, glm::mat4>
constexpr auto std430Compliant() -> size_t
{
    return 16;
}
...
constexpr auto validateStructMembers()
{
    ...
    boost::pfr::for_each_field(S{}, [&]<size_t I>(auto &field) -> void {
        ...
        // align currentOffset, then validate
        currentOffset += paddingNeeded<currentOffset, std430Compliant<FieldType>()>();
        valid &= isStd430Compliant<FieldType, currentOffset, S, I>();
